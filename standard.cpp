...
Sum is 17.
3*1times + 1*6times + 2*2times + 4*1times = 17

3 1 2 4 

what is the previous smaller number index of 1 ---> -1  so number of elements on the left which are smaller than 1 (1 inclusive) 1-(-1) =2 
what is the next smaller number index of 1 ---> 4  so number of elements 4-1 = 3 
